...
import es.jaga.webagrupados.model.facades.RolesFacade;
...
public class RolesController implements Serializable {
    ...
    @EJB
    private es.jaga.webagrupados.model.facades.RolesFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/es/jaga/webagrupados/es_bundle").getString("RolesCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/es/jaga/webagrupados/es_bundle").getString("RolesUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/es/jaga/webagrupados/es_bundle").getString("RolesDeleted"));
        if (!JsfUtil.isValidationFailed()) {
