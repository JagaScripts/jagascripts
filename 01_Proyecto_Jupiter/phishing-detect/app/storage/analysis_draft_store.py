...
_KEY_PREFIX = "phishing:analysis_draft"
...
def get_analysis_draft(user_id: str, session_id: str) -> dict[str, Any]:
    """
    Recupera el borrador de análisis asociado a una sesión
...
def upsert_analysis_draft(user_id: str, session_id: str, patch: dict[str, Any]) -> dict[str, Any]:
    """
    Crea o actualiza el borrador de análisis para una sesión
...
def clear_analysis_draft(user_id: str, session_id: str) -> None:
    """
    Elimina el borrador de análisis asociado a una sesión
