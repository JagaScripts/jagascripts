...
_KEY_PREFIX = "phishing:domain_draft"
...
def get_domain_draft(user_id: str, session_id: str) -> dict[str, Any]:
    """
    Recupera el borrador de dominio asociado a una sesión
...
def upsert_domain_draft(user_id: str, session_id: str, patch: dict[str, Any]) -> dict[str, Any]:
    """
    Crea o actualiza el borrador de dominio para una sesión
...
def clear_domain_draft(user_id: str, session_id: str) -> None:
    """
    Elimina el borrador de dominio asociado a una sesión
